                ...
                <div class="col-md-6 col-xl-4">
                    <div class="luxury-card h-100">
                        <div style="height: 400px; overflow: hidden; position: relative;">
                            ...
                            @auth
                            <form action="{{ route('wishlist.add', $watch->id) }}" method="POST" class="position-absolute top-0 end-0 m-3">
                                @csrf
                                <button class="btn btn-dark bg-opacity-75 btn-sm border-0 rounded-circle text-warning shadow-sm" style="width: 32px; height: 32px; display: flex; align-items: center; justify-content: center;" title="Add to Wishlist">
