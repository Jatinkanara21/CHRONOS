...
<nav class="navbar navbar-expand-lg fixed-top navbar-dark">
    <div class="container">
        <a class="navbar-brand text-gold-gradient" href="<?php echo e(route('home')); ?>">CHRONOS</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('watches.index')); ?>">Timepieces</a></li>
                ...
                <?php else: ?>
                    <li class="nav-item position-relative">
                        <a class="nav-link" href="<?php echo e(route('cart.index')); ?>">
                            ...
                            <?php $count = \App\Models\CartItem::where('user_id', Auth::id())->sum('quantity'); ?>
                            <?php if($count > 0): ?>
                                <span class="position-absolute top-0 start-100 translate-middle badge rounded-circle bg-warning text-dark" style="font-size: 0.6rem;"><?php echo e($count); ?></span>
                            <?php endif; ?>
                        </a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end bg-dark border-secondary shadow-lg">
                            <li><a class="dropdown-item text-light small ls-3" href="<?php echo e(route('orders.history')); ?>">ORDERS</a></li>
                            <?php if(Auth::user()->is_admin): ?>
                            <li><a class="dropdown-item text-warning small ls-3" href="<?php echo e(route('admin.dashboard')); ?>">ADMIN</a></li>
                            <?php endif; ?>
                            <li><hr class="dropdown-divider bg-secondary"></li>
                            <li>
                                <form action="<?php echo e(route('logout')); ?>" method="POST"><?php echo csrf_field(); ?><button class="dropdown-item text-danger small ls-3">LOGOUT</button></form>
                            </li>
                        </ul>
                    </li>
                <?php endif; ?>
...
<footer>
    <div class="container text-center">
        ...
        <div class="mt-5 pt-4 border-top border-secondary opacity-25">
            <p class="small">&copy; <?php echo e(date('Y')); ?> Haute Horlogerie. All Rights Reserved.</p>
        </div>
    </div>
</footer>
