...
Route::middleware(['auth'])->prefix('admin')->group(function () {
    ...
    // Admin Notifications
    Route::get('/notifications', [AdminController::class, 'notifications'])->name('admin.notifications.panel');
    Route::post('/notifications/toggle', [AdminController::class, 'toggleNotifications'])->name('admin.notifications.toggle');
    Route::post('/notifications/broadcast', [AdminController::class, 'broadcast'])->name('admin.notifications.broadcast');
});
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/notifications/settings', [App\Http\Controllers\WishlistController::class, 'settings'])->name('notifications.settings');
    Route::post('/notifications/settings', [App\Http\Controllers\WishlistController::class, 'updateSettings'])->name('notifications.update');
    ...
    Route::post('/notifications/read/{id}', function ($id) {
        ...
        if (isset($n->data['url']) && !empty($n->data['url'])) {
